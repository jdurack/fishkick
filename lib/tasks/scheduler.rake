...
def getDischargeRateFishScoreScalingFactor( site_fish_info, date )
...
def getMedianDischargeRate( site, date )
  ...
  #puts 'min: ', sortedData[0].value.to_s, ', median: ', median, ', max: ', sortedData[sortedData.length - 1].value.to_s
  return median
end
